...
// Agregar evento para cuando el usuario ha dejado de presionar el ratón
...
// Agregar evento para el dibujo contínuo al mover el ratón
canvas.addEventListener('mousemove',function(evt){
    if(dibujar){
        var m = oMousePos(canvas,evt); // Obtener la posición del puntero del ratón
        puntos.push(m); // Almacenar la posición del puntero del ratón
        ctx.lineTo(m.x,m.y); // Dibujar una línea desde el último punto hasta el punto actual
